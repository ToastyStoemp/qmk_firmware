...
#define PRODUCT_ID   0x0064 // Agile 65
#define DEVICE_VER   0x0001 // Version 1
#define MANUFACTURER    Agile
#define PRODUCT         Agile 65
...
#define MATRIX_ROW_PINS { B9, B1, B2, B14, B13 }
#define MATRIX_COL_PINS { B8, B0, A7, A6, A5, A4, A3, A2, A1, A0, F1, F0, C15, C14, C13 }
#define UNUSED_PINS
