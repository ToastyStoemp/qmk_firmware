...
#define PRODUCT_ID   0x0065 // KeebBoy
#define DEVICE_VER   0x0001 // Version 1
#define MANUFACTURER    Playmaker X Personal Loot
#define PRODUCT         KeebBoy
...
#define MATRIX_ROW_PINS { D5, D3, D2, B0, B2 }
#define MATRIX_COL_PINS { B7, F0, F1, F4, F5, F6, F7, C7, C6, B6, B5, B4, D7, D6 }
#define UNUSED_PINS
